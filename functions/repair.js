...
const startMarker = `                        await lineClient.replyMessage({
...
const newContent = content.substring(0, startIndex + startMarker.length) + replacement + content.substring(endIndex);
